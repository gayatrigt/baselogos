...
export default function GalleryPage() {
  ...
  return (
    <div className='mx-auto flex flex-col w-screen items-center justify-center px-5'>
      ...
      {activeView === 'owned' && !isConnected ? (
      ...
      ) : data?.pages.some((page) => page.nfts.length > 0) ? (
        ...
        <div className='text-center text-gray-500 md:mt-7 mt-5 rounded-lg md:p-5 p-3 w-full max-w-max flex flex-col h-[70vh]'>
          <p className='mb-4 text-black'>
            It seems you don't have any NFTs yet.
          </p>
          <Link
            href='/'
            className='rounded py-3 px-4 bg-blue-600 text-white/90 text-base font-medium w-full  transition-colors'
          >
            Mint Now
          </Link>
        </div>
